...
//                    Toast.makeText(this@EmployeeDetailActivity, mMessage, Toast.LENGTH_SHORT).show()
                    ...
                    if(mCode == 200) {
                        ...
                        if(mData?.profile_img == null) {
                            ...
                            Glide.with(this@BoardDetailActivity).load(getString(R.string.basic_profile_url)).into(mEmployeeProfile)
                        }
                        else {
                            Glide.with(this@BoardDetailActivity).load(mData?.profile_img).into(mEmployeeProfile)
                        }
                    }
                }
